...
class TheaterViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        theaterLabel.font = UIFont(name: "Pretendard-Regular", size: 17)
        NSLayoutConstraint.activate([
            ...
            theaterLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 12),
            theaterLabel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -12)
        ])
    }
